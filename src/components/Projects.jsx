  ...
  return (
    <div id='projects' className='max-w-[1040px] m-auto lg:pl-4 md:pl-20 p-4 py-16'>
        ...
        <div className='grid sm:grid-cols-2 gap-12'>
            ...
            <ProjectItem img={FRFImg} title='Face Swap Filter' skills_used={'Python, Dlib, OpenCV'} description={'A face swap filter using facial detection that takes one video with one face and an image of another face'} link={'https://github.com/phan603/CS445-final-project'}/>
            ...
            <ProjectItem img={MLEImg}   title={<>Coming Soon:<br />Hot Dog Not Hot Dog</>} skills_used={'Python, TensorFlow, Keras'} description={'Inspired by a recent watch of the show Silicon Valley, this is a Convolutional Neural Network trained to detect whether an image is Hot Dog or not Hot Dog'}/>
        </div> 
    </div>
  )
}
